component persistent="true" table="custom" extends="base" {
    ...
    /**
     * Return begins in format (mmm d, yyyy)
     * If begins is null, use when entity was created
     */
    ...
    /**
     * Return ends in format (mmm d, yyyy)
     * If ends is null, use when entity was created
     */
